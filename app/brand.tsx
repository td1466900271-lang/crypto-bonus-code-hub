...
export function ExchangeLogo({name}:{name:string}){
 if(name==="Binance")return <svg viewBox="0 0 40 40" aria-label="Binance"><g fill="#f0b90b"><path d="M20 1.5 25.5 7 20 12.5 14.5 7Z"/><path d="M7 14.5 12.5 20 7 25.5 1.5 20Z"/><path d="M33 14.5 38.5 20 33 25.5 27.5 20Z"/><path d="M20 27.5 25.5 33 20 38.5 14.5 33Z"/><path d="M20 14.5 25.5 20 20 25.5 14.5 20Z"/></g></svg>;
